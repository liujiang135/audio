...
export default {
    ...
    initMultifunctionData(multifunctionUIInfo, url) {
        ...
        multifunctionData.itemTwo = itemView.convertJson(multifunctionUIInfo.displayItemTwo, url,
            multifunctionUIInfo.gravity, multifunctionUIInfo.heightType, 'center');
