...
public abstract class BaseDeviceDataHandler {
    ...
    public BaseDeviceDataHandler(String deviceId, DeviceDataCallback deviceDataCallback) {
     ...
     */
    public final void initProfileData(int errorCode, String errorMessage, Map<String, Object> dataMap) {
     ...
     * @param dataMap the data to send
     */
    public void onDeviceDataChange(Map<String, Object> dataMap) {
