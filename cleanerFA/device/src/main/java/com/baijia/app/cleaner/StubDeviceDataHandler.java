...
//
//    static final String TEMPLATE_DIR = "resources/template";
...
//    static final String EXAMPLE_DEVICE_ID = "0001";
    ...
    static final String EXAMPLE_PRODUCT_ID = CLEANER;
    ...
    private final DeviceDataModel cleanerDataModel = new DeviceDataModel() {
        ...
        private void resetData() {
            ...
            // Brush
            sampleDataMap.put("runningMode/mode", 0);
            sampleDataMap.put("ledMode/mode", 0);
...
//        if (CLEANER.equals(EXAMPLE_PRODUCT_ID)) {
            dataModel = cleanerDataModel;
//        } else
//
